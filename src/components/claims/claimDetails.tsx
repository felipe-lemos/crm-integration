    ...
    <CSSTransition in={show} timeout={300} classNames="slide" unmountOnExit>
      <Spacings.Stack scale="m">
        <div>
          ...
          >
            <Text.Body as="span">{`< Back to Claims`}</Text.Body>
          </span>
        </div>
        <Text.Headline as="h2">Claim Details</Text.Headline>
        <div>
          <div className="gap-10">
            <Text.Body as="p">{`Claim Title: ${selectedClaim.name}`}</Text.Body>

            <Text.Body as="p">{`Claim Status: ${selectedClaim.status}`}</Text.Body>

            <Text.Body as="p">{`Claim Description:`}</Text.Body>
          ...
          <div className="between-space">
            <Text.Body as="p">Selected Claim Details:</Text.Body>
